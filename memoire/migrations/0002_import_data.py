# Generated by Django 3.1.7 on 2021-03-23 18:08
...
countries = [
    ...
    {'timezones': ['America/Guatemala'], 'code': 'HT', 'continent': 'North America', 'name': 'Haiti',
    ...
    {'timezones': ['America/Puerto_Rico'], 'code': 'PR', 'continent': 'America', 'name': 'Puerto Rico',
     'capital': 'San Juan'},
]
...
references = [{
    'authors': ['Abdelhadi'],
    'year': 2018,
    'title': 'Maintenance scheduling based on PROMETHEE method in conjunction with group technology philosophy.',
...
def add_data(apps, schema_editor):
    ...
    for j in journals:
        Journal.objects.create(name=j)

    Affiliation = apps.get_model('memoire', 'Affiliation')
    for a in affiliations:
        Affiliation.objects.create(name=a)
    ...
    for a in authors:
        Author.objects.create(
            ...
            email=a['email'],
            country=Country.objects.get(code=a['code']),
            affiliation=Affiliation.objects.get(name=a['affiliation'])
        )
    ...
    for r in references:
        created_reference = Reference.objects.create(
            ...
            pages=r['pages'],
            volume=r['volume'],
            journal=Journal.objects.get(name=r['journal'])
        )

        for a in r['authors']:
            created_reference.authors.add(Author.objects.get(last_name=a))
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(add_data, delete_data),
    ]
